...
for i in range(9):
    time.sleep(10)
    process1 = subprocess.Popen(["python", "gen_data_csv1.py"]) # Create and launch process 
    ...
    process6 = subprocess.Popen(["python", "gen_data_csv6.py"]) # Create and launch process pop.py using python interpreter
